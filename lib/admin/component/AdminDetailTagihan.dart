...
class AdminDetailTagihan extends StatefulWidget {
  const AdminDetailTagihan(
  ...
  @override
  State<AdminDetailTagihan> createState() => _AdminDetailTagihanState();
}

class _AdminDetailTagihanState extends State<AdminDetailTagihan> {
  String token = "";
  var id = 0.obs;
  var no_order = "".obs;
  var airway_bill = "".obs;
