...
class _AdminKeuanganState extends State<AdminKeuangan> {
  ...
  void getDataKeuangan() async {
    ...
    try {
      ...
      keuntungan.value = resultData['data']['keuntungan'];
    } catch (e) {
      print(e);
    }
    setState(() {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Obx(() => Text(dana_belum_kembali.value.toString(),
                                          style: const TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.bold,
                                              color: PaylaterTheme.decline)),),
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                      Obx(() => Text("${data_cicilan_aktif.value} Cicilan",
                                          style: const TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.bold,
